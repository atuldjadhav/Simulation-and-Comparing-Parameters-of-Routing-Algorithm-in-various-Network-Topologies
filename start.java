...
public class start extends JFrame implements ActionListener
{
 ...
 //tLocation(300,65);
  ...
  p1.setBackground(new Color(180,180,180));
  c.add(p1);
  p1.add(new algosel());
  ...
  class topologysel extends JPanel implements ActionListener,ItemListener
 {
  ...
  public topologysel()
  {
   ...
   jtf.setBackground(new Color(180,180,180));
   ...
   jl2=new JLabel("Select a Topology:");
   jl1=new JLabel("File:");
   jl2.setForeground(new Color(0,0,0));
   jl1.setForeground(new Color(0,0,0));
   jtf.setForeground(new Color(0,0,0));
   jl2.setBounds(15,10,125,25);
   jl1.setBounds(15,50,45,25);
   jc1.setBounds(55,50,110,25);
   jtf.setBounds(60,10,110,25);
   b1.setBounds(70,100,70,25);
   b2.setBounds(170,50,25,25);
   add(jl1);add(jl2);add(jc1);add(b1);add(b2);
...
class fileedit extends JFrame implements ActionListener
{
 ...
 public void actionPerformed(ActionEvent ae)
 {
  if((ae.getActionCommand()).equals("Open"))
  {
   try{
     ...
     jfc.setCurrentDirectory(new File("C:\\Users\\MIKYAJUMBO\\Desktop\\New folder"));
 ...
 class nodedraw extends JPanel
 {
  ...
  public nodedraw()
  {
   ...
   for(int i=0;i<tr.nodename.size();i++)
   {
    double d1=Double.parseDouble((""+tr.nodexcord.get(i)))*(1140/2);
    double d2=Double.parseDouble((""+tr.nodeycord.get(i)))*(880/2);
  ...
  void findlinkstart(String linkstart)
 {
  ...
  for(int i=0;i<tr.nodename.size();i++)
  {
    ...
    {
      d1=Double.parseDouble((""+tr.nodexcord.get(i)))*(1140/2);
      d2=Double.parseDouble((""+tr.nodeycord.get(i)))*(880/2);
      x1=(int) d1;
      y1=(int) d2;
    }
   }
